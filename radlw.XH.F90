...
subroutine rad_rrtmg_lw(lchnk   ,ncol      ,rrtmg_levs,r_state,       &
                        ...
                        !yihsuan cancel lu      ,ld        )
                        lu,           ld, rtr2_flag, ssac_lw, xmomc_lw, surface_emis, ful, fsul, fdl, fsdl, spec_lwdn )
...
!yihsuan comment,   real(r8) :: fsdl(pcols,pverp)    ! Clear sky downwards longwv flux
   ...
   !yihsuan cancel call mcica_subcol_lw(lchnk, ncol, rrtmg_levs-1, icld, permuteseed, pmid(:,pverp-rrtmg_levs+1:pverp-1), &
   !yihsuan cancel   cld(:, pverp-rrtmg_levs+1:pverp-1), cicewp, cliqwp, rei, rel, tauc_lw(:, :ncol, pverp-rrtmg_levs+1:pverp-1), &
   !yihsuan cancel   cld_stolw, cicewp_stolw, cliqwp_stolw, rei_stolw, rel_stolw, tauc_stolw)
   ...
   call mcica_subcol_lw(lchnk, ncol, rrtmg_levs-1, icld, permuteseed, pmid(:, pverp-rrtmg_levs+1:pverp-1), &
      ...
      ssac_lw(:, :ncol, pverp-rrtmg_levs+1:pverp-1), xmomc_lw(:, :, :ncol,pverp-rrtmg_levs+1:pverp-1), &
      cld_stolw, cicewp_stolw, cliqwp_stolw, rei_stolw, rel_stolw, tauc_stolw, ssac_stolw, xmomc_stolw)
   !<<< yihsuan add 2017-07-04 <<<
   ...
   !yihsuan cancel call rrtmg_lw(lchnk  ,ncol ,rrtmg_levs    ,icld, rtr2_flag    ,                 &
   call rrtmg_lw(lchnk  ,ncol ,rrtmg_levs    ,icld, rtr2_flag    ,                 &
                 ...
                 !yihsuan cancel cld_stolw,tauc_stolw,cicewp_stolw,cliqwp_stolw ,rei, rel, &
   ...
   !yihsuan comment if (single_column.and.scm_crm_mode) then
   !yihsuan comment   call outfld('FUL     ',ful,pcols,lchnk)
   !yihsuan comment   call outfld('FDL     ',fdl,pcols,lchnk)
   !yihsuan comment   call outfld('FULC    ',fsul,pcols,lchnk)
   !yihsuan comment   call outfld('FDLC    ',fsdl,pcols,lchnk)
   !yihsuan comment endif
