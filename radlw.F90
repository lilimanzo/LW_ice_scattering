...
CONTAINS
!===============================================================================
! LM / Yihsuan added rtr2_flag, ssac_lw, xmomc_lw, surface_emis, ful, fsul, fdl, fsdl, spec_lwdn
subroutine rad_rrtmg_lw(lchnk   ,ncol      ,rrtmg_levs,r_state,       &
                        ...
                        lu      ,ld        ,                          &
                        rtr2_flag,ssac_lw  ,xmomc_lw  ,surface_emis , &
                        ful     ,fsul      ,fdl       ,fsdl         , &
                        spec_lwdn                                     )
...
!
   ...
   ! LM / Yihsuan added rtr2_flag, ssac_lw, xmomc_lw, surface_emis
...
!
   ...
   ! LM / Yihsuan added ful, fsul, fdl, fsdl, spec_lwn, ssac_stolw, xmomc_stolw
   ...
   integer, parameter :: nsubclw = ngptlw       ! rrtmg_lw g-point (quadrature point) dimension - LM moved
...
!
   ...
   ! LM / Yihsuan added rtr2_flag, ssac_stolw, xmomc_stolw
   ...
   ! LM / Yihsuan add spec_lwdn
   spec_lwdn      = 0._r8
   spec_lwdn(:,:) = lwdflxs(:,:ncol,1)
   ...
   ! LM / Yihsuan comment if statement
