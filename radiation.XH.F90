...
!===============================================================================
  ...
  subroutine radiation_tend(state,ptend, pbuf, &
    ...
    use cloud_rad_props,  only: get_ice_optics_sw, get_liquid_optics_sw, liquid_cloud_get_rad_props_lw, &
               ice_cloud_get_rad_props_lw, cloud_rad_props_get_lw, snow_cloud_get_rad_props_lw, get_snow_optics_sw, tamu_ice_get_rad_props_lw
...
!-----------------------------------------------
    ...
    !logical, parameter :: mc6_scat_flag  = .False. 
                                                   ! .True.   : turn on  ice cloud LW scattering
                                                   ! .False.  : tunr off ice cloud LW scattering
